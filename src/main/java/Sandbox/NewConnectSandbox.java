...
public class NewConnectSandbox {
	...
	public void checkValueA(){
		System.out.println("checkValueA Method is called....");
	}
	
	public void checkValueB(){
		System.out.println("checkValueB Method is called....");
	}
...
//		softAssert.assertEquals("Google", "Google", "Strings are not matching");
		
//		softAssert.assertEquals("Gooogle", "google", "Strings are not matching");
	...
	@Test(priority=1)
	public void testOrderSubmit(String salesChannel){
...
//		This is to add voip service.
	    ...
	    try{
	    	...
	    	System.out.println("FSM scheduling screen hangs for more than two minutes.\n"
		...
		if(transactionStatus.equals("ERROR")){
			...
			softAssert.fail("New_Connect transaction ended in ERROR...");
		}
		
		System.out.println("Order Created Succesfully. Back to the first page of Order Entry.");
		
//		WebElement wbTransactionGlyphicon = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id="datatable"]/tbody/tr[3]/td[2]/a/span")))
	...
	public void testProvisioning(String salesChannel){
	...
	private void validateStatus(WebDriver driver, String status, SoftAssert sassert){
		...
		WebElement transactionStatusLabel = driver.findElement(By.xpath("//*[@id=\"datatable\"]/tbody/tr[1]/td[7]/div[1]"));
